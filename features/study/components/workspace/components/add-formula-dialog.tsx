...
export function AddFormulaDialog({
  ...
  return (
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="sm:max-w-xl max-h-[90vh] overflow-y-auto bg-background/95 backdrop-blur-xl border-glass-border">
        <DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-5 pt-2">
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              className="w-full bg-surface/50 border border-glass-border rounded-xl p-3 resize-none text-xs text-foreground outline-none"
              rows={2}
            />
          </div>
